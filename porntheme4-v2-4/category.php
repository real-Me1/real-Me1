...
<div id="content">
  <div id="inner-wrap">
    ...
    <header id="archive-header">
      <h1 id="archive-title"><?php printf( __( '%s', 'porntheme' ), single_cat_title( '', false ) ); ?> Porn Videos</h1>
      <?php $term_description = term_description(); if ( ! empty( $term_description ) ) : printf( '<div id="archive-description">%s</div>', $term_description ); endif; ?>
    </header>
	<?php 
