...
<div id="wrap-3">
  <div id="content">
    <div id="inner-wrap">
	  ...
	  if ( get_theme_mod( 'thumb_rounded_borders' ) != 'no') {$rounded = "yes";}
	  if ( is_active_sidebar( 'second-in-tube-ad' )) { if( $wp_query->current_post == 15 ) { if ($rounded == "yes") { echo '<span class="rounded-borders">';} echo '<div id="second-in-tube-ad">'; dynamic_sidebar( 'second-in-tube-ad' ); echo '</div>'; if ($rounded == "yes") { echo '</span>';} } }
	  if ( is_active_sidebar( 'third-in-tube-ad' )) { if( $wp_query->current_post == 29 ) { if ($rounded == "yes") { echo '<span class="rounded-borders">';} echo '<div id="third-in-tube-ad">'; dynamic_sidebar( 'third-in-tube-ad' ); echo '</div>'; if ($rounded == "yes") { echo '</span>';}  } }
	  endwhile;
